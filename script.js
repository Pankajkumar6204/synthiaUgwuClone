...
// for hero section open delay and ease in Out
...
// circle chapta hoga and uske bad proper position me aa jayega
function circleWidthIncrease() {
    var xscale = 1;
    var yscale = 1;
